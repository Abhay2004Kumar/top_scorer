        ...
        <div className={style.teamslogo}>
          <div className={style.tone}>
            <div className={style.img1}>
              <img
                src={teamData.team1.logo}
                alt={`${teamData.team1.name} logo`}
              />
            </div>
          ...
          <div className={style.ttwo}>
            <div className={style.img2}>
              <img
                src={teamData.team2.logo}
                alt={`${teamData.team2.name} logo`}
              />
            </div>
            <div className={style.score}>
        ...
        <div className={style.predictorbox}>
          ...
          <div className={style.currover}>
            ...
            <div className={style.status}>
              <p>
                Last Over {teamData.lastOver.runs} Runs{" "}
                {teamData.lastOver.wickets} Wicket
              </p>
            </div>
          </div>
        </div>
